...
std::string ShaderLoader::ReadShader(char *filename) {
	...
	//seek to the end of the file to know it's size.
	file.seekg(0, std::ios::end);
	//tell us the size so we can resize the string that will hold the input.
...
GLuint ShaderLoader::CreateProgram(char* vertexShaderFilename, char* fragmentShaderFilename) {
	//read the shader code files and save the result in memory.
	...
	int link_result = 0;
	//create the program handles, attach the shaders, and link them.
